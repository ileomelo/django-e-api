...
from recipes.views.api import RecipeV2DetailView, RecipeV2ListView
...
urlpatterns = [
    ...
    path("api/v2/", RecipeV2ListView.as_view(), name="recipe_v2_list"),
    path("api/v2/<int:pk>/", RecipeV2DetailView.as_view(), name="recipe_v2_detail"),
